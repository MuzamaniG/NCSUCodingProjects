...
public class GraphTraversalUtil {
    ...
    /**
     * Helps the depthFirstSearch method
     * @param <V> Vertex data type
     * @param <E> Edge data type
     * @param graph containing edges
     * @param u vertex being handled
     * @param known set of vertices
     * @param forest map of vertices and edges
     */
