...
public class HeapAdaptablePriorityQueue<K extends Comparable<K>, V> extends HeapPriorityQueue<K, V>
    ...
    public void remove(Entry<K, V> entry) {
        AdaptablePQEntry<K, V> oldEntry = validate(entry);
        int index = oldEntry.getIndex();
    ...
    /** 
     * Bubbling algorithm helps to determine whether to upHeap or downHeap
