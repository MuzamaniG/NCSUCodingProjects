...
public abstract class AbstractPriorityQueue<K extends Comparable<K>, V> implements PriorityQueue<K, V> {
    ...
    public class NaturalOrder implements Comparator<K> {
    	/** 
    	 * Compares two keys
    	 * @param first key being compared
    	 * @param second key being compared
    	 * @return int for whether first is smaller or larger than second
    	 */
     ...
     * @return PQEntry with given key and value
     */
